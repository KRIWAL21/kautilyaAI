...
<template>
  <section class="px-6 space-y-6 text-white min-h-screen">
    <div class="flex items-center justify-between">
      <h1 class="font-bold text-[24px] md:text-[30px]">Privacy Policy</h1>
    </div>

    <div class="text-sm leading-relaxed space-y-4">

      <h2 class="font-semibold text-lg">1. GENERAL</h2>
      ...
      <p>
        b) This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of www.rezide.in
      </p>

      <p>
        c) The domain name www.rezide.in (“Website“), is owned and operated by <strong>Kautilya AI</strong> is a Real Estate focussed software solutions company with its registered office at 1704, Lodha Supremus, Saki Vihar Road, Powai Andheri East, Mumbai - 400072, and its subsidiaries, group companies & affiliates. where such expression shall, unless repugnant to the context thereof, be deemed to include its respective representatives, administrators, employees, directors, officers, agents and their successors and assigns.
      </p>
      ...
      <p>
        e) The User is aware that any and all information pertaining to the User collected by the Company, whether or not directly provided by the User to the Company/Website, including but not limited to personal correspondence such as emails or letters, feedback from other users or third parties regarding the User's activities or postings on the Website, etc., may be collected and complied by the Company/Website into a a file/folder specifically created for / allotted to the User, and the User hereby expressly consents to the same.
      </p>
      ...
      <h2 class="font-semibold text-lg">3. COOKIES</h2>
      ...
      <h2 class="font-semibold text-lg">4. DIVULGING/SHARING OF PERSONAL INFORMATION</h2>
      ...
      <h2 class="font-semibold text-lg">5. SECURITY</h2>

      <p>
        Transactions on the Website are secure and protected. Any information entered by the User when transacting on the Website is encrypted to protect the User against unintentional disclosure to third parties. The User's credit and debit card information is not received, stored by or retained by the Company / Website in any manner. This information is supplied by the User directly to the relevant payment gateway which is authorized to handle the information provided, and is compliant with the regulations and requirements of various banks and institutions and payment franchisees that it is associated with.
      </p>

      <h2 class="font-semibold text-lg">6. THIRD PARTY ADVERTISEMENTS / PROMOTIONS</h2>
      ...
      <h2 class="font-semibold text-lg">7. USER'S CONSENT</h2>
      ...
      <h2 class="font-semibold text-lg">8. GRIEVANCE OFFICER</h2>
      ...
      <p>
        Arpan Dengla : arpan.dengla@rezide.in
      </p>

      <h2 class="font-semibold text-lg">9. DISPUTE RESOLUTION AND JURISDICTION</h2>
